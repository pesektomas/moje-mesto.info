				...
				<div className="card-body">
					<div className="list-group">
						{this.props.data.slice(0, this.state.limit).map((item, idx) => {
							return <a href={item.link} target="_blank" className="list-group-item list-group-item-action" key={`dataRenderer_${this.props.dataName}_${idx}`}>
								<div className="d-flex w-100 justify-content-between">
									<h5 className="mb-1"></h5>
									<small>
										<FormattedDate value={item.pubDate} />
									</small>
								</div>
